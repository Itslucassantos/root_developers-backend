...
@NoArgsConstructor
@Entity
@Table(name = "tb_legal_clients")
public class LegalClientModel implements UserDetails, IClientModel {
    ...
    private UUID legalClientId;

    @Column(name = "social_reason", length = 255, nullable = false)
    ...
    public LegalClientModel(ClientDataDto clientDataDto, AddressModel addressModel) {
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        return List.of(new SimpleGrantedAuthority("ROLE_LEGAL_CLIENT"));
    }
